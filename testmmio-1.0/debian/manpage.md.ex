% testmmio(SECTION) | User Commands
%
% "August 23 2026"
...
testmmio - program to do something

# SYNOPSIS

**testmmio** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**testmmio** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **testmmio** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**testmmio** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    testmmio. See **foo.conf**(5) for further details.
...
**testmmio** provides some return codes, that can be used in scripts:
...
user <a.doroshev@securitycode.ru>
